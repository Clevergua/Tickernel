...
layout(set = SUBPASS_DESCRIPTOR_SET, binding = 4) uniform LightsUniform {
...
layout(set = SUBPASS_DESCRIPTOR_SET, input_attachment_index = 0, binding = 0) uniform subpassInput i_depth;
