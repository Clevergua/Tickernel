...
--         if voxelMap[x - 1][y][z] ~= nil or voxelMap[x - 1][y][z] ~= centerValue then
--             normals[i][1] = normals[i][1] + 1
--         end
--         if voxelMap[x + 1][y][z] ~= nil or voxelMap[x + 1][y][z] ~= centerValue then
--             normals[i][1] = normals[i][1] - 1
--         end
--         if voxelMap[x][y - 1][z] ~= nil or voxelMap[x][y - 1][z] ~= centerValue then
--             normals[i][2] = normals[i][2] + 1
--         end
--         if voxelMap[x][y + 1][z] ~= nil or voxelMap[x][y + 1][z] ~= centerValue then
--             normals[i][2] = normals[i][2] - 1
--         end
--         if voxelMap[x][y][z - 1] ~= nil or voxelMap[x][y][z - 1] ~= centerValue then
...
--         if voxelMap[x - 1][y - 1][z - 1] ~= nil or voxelMap[x - 1][y - 1][z - 1] ~= centerValue then
...
--         length = 1 / 1.414
--         if voxelMap[x - 1][y - 1][z] ~= nil or voxelMap[x - 1][y - 1][z] ~= centerValue then
--             normals[i][1] = normals[i][1] + length
--             normals[i][2] = normals[i][2] + length
--         end
--         if voxelMap[x - 1][y + 1][z] ~= nil or voxelMap[x - 1][y + 1][z] ~= centerValue then
...
--             normals[i][2] = normals[i][2] - length
--         end
--         if voxelMap[x - 1][y][z - 1] ~= nil or voxelMap[x - 1][y][z - 1] ~= centerValue then
--             normals[i][1] = normals[i][1] + length
--             normals[i][3] = normals[i][3] + length
--         end
--         if voxelMap[x - 1][y][z + 1] ~= nil or voxelMap[x - 1][y][z + 1] ~= centerValue then
...
--             normals[i][3] = normals[i][3] - length
--         end
--         if voxelMap[x][y - 1][z - 1] ~= nil or voxelMap[x][y - 1][z - 1] ~= centerValue then
--             normals[i][2] = normals[i][2] + length
--             normals[i][3] = normals[i][3] + length
--         end
--         if voxelMap[x][y - 1][z + 1] ~= nil or voxelMap[x][y - 1][z + 1] ~= centerValue then
